...
//     const answer = Number(
//       prompt(
//         'What is your favourite programming language? (Write option number)'
//       )
//     );
...
1. Create a method called 'registerNewAnswer' on the 'poll' object. The method does 2 things:
  ...
  For example, if the option is 3, increase the value AT POSITION 3 of the array by 1. Make sure 
...
// const addVAT = price => addTax(price, 0.23);
